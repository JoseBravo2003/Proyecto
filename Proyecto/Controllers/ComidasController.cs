...
namespace Proyecto.Controllers
{
    public class ComidasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdComida,Nombre,Descripcion,Precio,Categoria")] Comida comida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdComida,Nombre,Descripcion,Precio,Categoria")] Comida comida)
        {
